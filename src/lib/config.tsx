...
/**
 * Gets localized pricing data based on the locale
 * This function is used by the pricing section component
 */
...
export const siteConfig = {
  ...
  links: {
    email: "support@rzev.ai",
    twitter: "https://twitter.com/rzevai",
    discord: "https://discord.gg/rzevai",
    instagram: "https://instagram.com/rzevai",
  },
  nav: {
    links: [
  ...
  hero: {
    ...
    badge: "Introducing smarter appointments",
    title: "Meet the AI front desk",
    titleLine2: "It never sleeps and never calls in sick",
    description:
      "AI-powered reservation software — so you never need staff to handle bookings, confirmations, or customer inquiries.",
    cta: {
      primary: {
        text: "Learn More",
        href: "https://cal.com/jerry-wu/15min",
      },
      secondary: {
        text: "Get Started",
        href: "#",
  ...
  footerLinks: [
    ...
    // },
    {
      ...
      links: [
        ...
        { id: 6, title: "Terms of Service", url: "/terms-of-service" },
